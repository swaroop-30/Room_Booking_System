...
int main()
{
	...
	Admin adminstrator("AD5123","James Anderson","admin123","04155867890","James.A@gmail.com");
	Member members("MS6625","Micheal Jordan","user123","04144685245","Staff","Micheal.Jordan@gmail.com");
	
	MemberList member;
	RoomList room;
	DoublyLinkedList booking; //linked list used
	/*booking.insert("MS6625", "Micheal Jordan", "user123", "04144685245", "Staff", "Micheal.Jordan@gmail.com", 8);
	booking.insert("MS6625", "Micheal Jordan", "user123", "04144685245", "Staff", "Micheal.Jordan@gmail.com", 8);*/
	int choice, num;
